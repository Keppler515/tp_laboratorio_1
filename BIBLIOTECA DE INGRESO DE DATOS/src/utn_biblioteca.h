...
void menu(float a, float b); //MUESTRA EL MENU POR PANTALLA Y A MEDIDA QUE RECIBE LOS VALORES LOS MUESTRA
...
int factorial(float a, int* pResultado);//RECIBE DOS NUMEROS FLOAT Y, EN CASO DE SER >0 Y TENER DECIMALES ==0 LO CASTEA A INT, RETORNA EL RESULTADO COMO ENTERO
